...
export const InputLogin = ({ textoTitulo, type,value,onChange, onClick }) => {
    return (
        ...
        <div className="form-outline form-white mb-4">
            ...
            <input  className="form-control text-center form-control-lg" type={type} placeholder={type} value={value} onClick = {onClick} onChange={(event) => onChange(event.target.value)} />
        </div>
    )
}
