...
export async function traerUsuario() {
  const response = await axios.get(
    ENV_DEV_URL + "/usuario/" + (await getUsuarioId())
  );
  return response.data;
}
...
export async function geocoder(datosDireccion) {
  const response = await axios.get(
    "https://nominatim.openstreetmap.org/search?" +
      `q=${datosDireccion.altura}%2C+${datosDireccion.calle}%2C+${datosDireccion.localidad}%2C+Partido de ${datosDireccion.partido}%2C+Buenos+Aires%2C+B${datosDireccion.codigopostal}%2C+Argentina+&format=json`
  );
  return response.data;
}
...
export async function crearVehiculo(vehiculoJSON) {
  const response = await axios.put(
    ENV_DEV_URL + "/agregarVehiculo/" + (await getUsuarioId()),
    vehiculoJSON
  );
  return response.data;
}
...
export async function modificarVehiculo(idVehiculo, marca, modelo, dominio) {
  ...
  const response = await axios.put(
    ENV_DEV_URL + "/modificarVehiculo/" + idVehiculo,
    vehiculoJSON
  );
  return response.data;
}
...
export async function traerVehiculosDelUsuario() {
  let response = await axios.get(
    ENV_DEV_URL + "/usuario/vehiculosPropios/" + (await getUsuarioId())
  );
  return response.data;
}
...
export async function traerRampasDelUsuario() {
  let response = await axios.get(
    ENV_DEV_URL + "/usuario/rampasPropias/" + (await getUsuarioId())
  );
  return response.data;
}
...
export async function traerReservasDelUsuario() {
  let response = await axios.get(
    ENV_DEV_URL + "/usuario/reservasActivas/" + (await getUsuarioId())
  );
  return response.data;
}
...
export async function denunciarInfractor(motivo, imagen, dominio, direccion) {
  ...
  const response = await axios.put(
    ENV_DEV_URL + "/realizarDenuncia/" + (await getUsuarioId()),
    denuncia
  );
  return response.data;
}
...
export async function traeCarrito() {
  const response = await axios.get(
    ENV_DEV_URL + "/usuario/carrito/" + (await getUsuarioId())
  );
  return response.data;
}
...
export async function pagarCarrito() {
  const response = await axios.post(
    ENV_DEV_URL + "/usuario/carrito/" + (await getUsuarioId()) + "/pagar"
  );
  return response.data;
}
...
export async function deshabilitarRampa(idRampa) {
  const response = await axios.delete(
    ENV_DEV_URL + "/eliminarHorarioRampa/" + idRampa
  );
  return response.data;
}
...
export async function habilitarRampa(idRampa, horarios) {
  const response = await axios.put(
    ENV_DEV_URL + "/agregarHorarioRampa/" + idRampa,
    horarios
  );
  return response.data;
}
...
export async function verificarPropiedadRampa(rampaJSON) {
  const response = await axios.put(
    ENV_DEV_URL + "/verificarPropiedadRampa/" + (await getUsuarioId()),
    rampaJSON
  );
  return response.data;
}
